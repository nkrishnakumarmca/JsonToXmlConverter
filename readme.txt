...
step 5: Then run this command java -jar target/jsonToXmlConverter-jar-with-dependencies.jar <your input file path with file name> <your output file path with name>
